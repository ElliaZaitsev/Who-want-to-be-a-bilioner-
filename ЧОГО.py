...
def funkcija_XEXEEXEXEXE():
    ...
    print(user_name)
    print(
        "если хочеш депнуть в каз то бепни все ну а если есть до деп то кинь еще а последний деп оставь вить окуп ждет все окупиться поверь еще еще!   (ГИМН КАЗИНО)"
    )
...
def q(number):
    ...
    def exit():
        ...
        pelmen = Label(
            text=f"ви програли😣 ваші бали {mycoins}",
            bg="white",
            fg="black",
            height=5,
            width=25,
            font=10000000000000000000000000000000000000000000,
        )
...
A = Button(
    ...
    height=5,
    width=25,
    font=10000000000000000000000000000000000000,
    command=q1,
)
A.place(x=283, y=570)
B = Button(
...
D = Label(
    ...
    height=7,
    width=35,
    font=10000000000000000000000000000000000,
)
D.place(x=610, y=290)
