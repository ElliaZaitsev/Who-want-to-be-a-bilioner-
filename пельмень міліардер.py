...
def rightanswer(Button):
    ...
    if Button["text"]==data[i]["correctanswer"]:
        ...
        #     cashprize["text"]="0"
        # elif i==2:
        #     cashprize["text"]="200.000"
        #     answers["text"] = "відповідь 2/10"
        # elif i==3:
        #     cashprize["text"]="300.000"
        #     answers["text"] = "відповідь 3/10"
        # elif i==4:
        #     cashprize["text"]="400.000"
        #     answers["text"] = "відповідь 4/10"
        # elif i==5:
        #     cashprize["text"]="500.000"
        #     answers["text"] = "відповідь 5/10"
        # elif i==6:
        #     cashprize["text"]="600.000"
        #     answers["text"] = "відповідь 6/10"
        # elif i==7:
        #     cashprize["text"]="700.000"
        #     answers["text"] = "відповідь 7/10"
        # elif i==8:
        #     cashprize["text"]="800.000"
        #     answers["text"] = "відповідь 8/10"
        # elif i==9:
        #     cashprize["text"]="900.000"
        #     answers["text"]="відповідь 9/10"
        if i==len(data):
            app.destroy()
            pelmencik=Tk()
...
podskazkaporada=Button(text="порaда гравця",fg="black",bg=PELMEN3,height=5,width=25,font=1000,)
